...
export const tripDocuments = [
  ...
  "Для обычного загранпаспорта РФ действует безвизовый въезд в КНР до 31 декабря 2027 года включительно на срок до 30 дней для бизнеса, туризма, посещения родственников и друзей, обменов и транзита; перед вылетом сверяйте актуальные условия по цели поездки.",
];
